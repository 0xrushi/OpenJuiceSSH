...
export fn Java_com_openjuicessh_app_core_terminal_GhosttyBridge_nativeVersion(env: *c.JNIEnv, clazz: c.jclass) callconv(.c) c.jstring {
    _ = clazz;
    return jniNewStringUTF(env, "1");
}

export fn Java_com_openjuicessh_app_core_terminal_GhosttyBridge_nativeCreate(env: *c.JNIEnv, thiz: c.jobject, cols: c.jint, rows: c.jint, max_scrollback: c.jint) callconv(.c) c.jlong {
    _ = env;
    _ = thiz;
    return chuchu_create_terminal(cols, rows, max_scrollback);
}

export fn Java_com_openjuicessh_app_core_terminal_GhosttyBridge_nativeDestroy(env: *c.JNIEnv, thiz: c.jobject, handle: c.jlong) callconv(.c) void {
    _ = env;
    _ = thiz;
    chuchu_destroy_terminal(handle);
}

export fn Java_com_openjuicessh_app_core_terminal_GhosttyBridge_nativeWriteRemote(env: *c.JNIEnv, thiz: c.jobject, handle: c.jlong, data: c.jbyteArray) callconv(.c) void {
    _ = thiz;
    if (data == null) return;
...
export fn Java_com_openjuicessh_app_core_terminal_GhosttyBridge_nativeResize(env: *c.JNIEnv, thiz: c.jobject, handle: c.jlong, cols: c.jint, rows: c.jint, cell_width: c.jint, cell_height: c.jint) callconv(.c) void {
    _ = env;
    _ = thiz;
    chuchu_resize(handle, cols, rows, cell_width, cell_height);
}

export fn Java_com_openjuicessh_app_core_terminal_GhosttyBridge_nativeScroll(env: *c.JNIEnv, thiz: c.jobject, handle: c.jlong, delta: c.jint, x: c.jfloat, y: c.jfloat) callconv(.c) void {
    _ = env;
    _ = thiz;
    chuchu_scroll(handle, delta, x, y);
}

export fn Java_com_openjuicessh_app_core_terminal_GhosttyBridge_nativeScrollToActive(env: *c.JNIEnv, thiz: c.jobject, handle: c.jlong) callconv(.c) void {
    _ = env;
    _ = thiz;
    chuchu_scroll_to_active(handle);
}

export fn Java_com_openjuicessh_app_core_terminal_GhosttyBridge_nativeSnapshot(env: *c.JNIEnv, thiz: c.jobject, handle: c.jlong) callconv(.c) c.jobject {
    _ = thiz;
    var size: usize = 0;
...
export fn Java_com_openjuicessh_app_core_terminal_GhosttyBridge_nativeSnapshotImages(env: *c.JNIEnv, thiz: c.jobject, handle: c.jlong) callconv(.c) c.jobject {
    _ = thiz;
    var size: usize = 0;
...
export fn Java_com_openjuicessh_app_core_terminal_GhosttyBridge_nativeIsImageLoading(env: *c.JNIEnv, thiz: c.jobject, handle: c.jlong) callconv(.c) c.jboolean {
    _ = env;
    _ = thiz;
...
export fn Java_com_openjuicessh_app_core_terminal_GhosttyBridge_nativePollTitle(env: *c.JNIEnv, thiz: c.jobject, handle: c.jlong) callconv(.c) c.jstring {
    _ = thiz;
    const value = chuchu_poll_title_ptr(handle) orelse return null;
    return jniNewStringUTF(env, value);
}

export fn Java_com_openjuicessh_app_core_terminal_GhosttyBridge_nativePollPwd(env: *c.JNIEnv, thiz: c.jobject, handle: c.jlong) callconv(.c) c.jstring {
    _ = thiz;
    const value = chuchu_poll_pwd_ptr(handle) orelse return null;
    return jniNewStringUTF(env, value);
}

export fn Java_com_openjuicessh_app_core_terminal_GhosttyBridge_nativeDrainBellCount(env: *c.JNIEnv, thiz: c.jobject, handle: c.jlong) callconv(.c) c.jint {
    _ = env;
    _ = thiz;
    return chuchu_drain_bell_count(handle);
}

export fn Java_com_openjuicessh_app_core_terminal_GhosttyBridge_nativeSetColorScheme(env: *c.JNIEnv, thiz: c.jobject, handle: c.jlong, scheme: c.jint) callconv(.c) void {
    _ = env;
    _ = thiz;
    chuchu_set_color_scheme(handle, scheme);
}

export fn Java_com_openjuicessh_app_core_terminal_GhosttyBridge_nativeSetMouseEncodingSize(env: *c.JNIEnv, thiz: c.jobject, handle: c.jlong, screen_width: c.jint, screen_height: c.jint, cell_width: c.jint, cell_height: c.jint, padding_top: c.jint, padding_bottom: c.jint, padding_left: c.jint, padding_right: c.jint) callconv(.c) void {
    _ = env;
    _ = thiz;
...
export fn Java_com_openjuicessh_app_core_terminal_GhosttyBridge_nativeEncodeKey(env: *c.JNIEnv, thiz: c.jobject, handle: c.jlong, key: c.jint, codepoint: c.jint, mods: c.jint, action: c.jint, utf8_jstring: c.jstring) callconv(.c) c.jbyteArray {
    _ = thiz;
...
export fn Java_com_openjuicessh_app_core_terminal_GhosttyBridge_nativeEncodeMouse(env: *c.JNIEnv, thiz: c.jobject, handle: c.jlong, action: c.jint, button: c.jint, mods: c.jint, x: c.jfloat, y: c.jfloat, any_button_pressed: c.jboolean, track_last_cell: c.jboolean) callconv(.c) c.jbyteArray {
    _ = thiz;
    const terminal = chuchuFromHandle(handle) orelse return jniEmptyByteArray(env);
...
export fn Java_com_openjuicessh_app_core_terminal_GhosttyBridge_nativeEncodeFocus(env: *c.JNIEnv, thiz: c.jobject, handle: c.jlong, focused: c.jboolean) callconv(.c) c.jbyteArray {
    _ = thiz;
    const terminal = chuchuFromHandle(handle) orelse return jniEmptyByteArray(env);
...
export fn Java_com_openjuicessh_app_core_terminal_GhosttyBridge_nativeDrainPtyWrites(env: *c.JNIEnv, thiz: c.jobject, handle: c.jlong) callconv(.c) c.jbyteArray {
    _ = thiz;
    const terminal = chuchuFromHandle(handle) orelse return jniEmptyByteArray(env);
...
export fn Java_com_openjuicessh_app_core_terminal_GhosttyBridge_nativeSetDefaultColors(env: *c.JNIEnv, thiz: c.jobject, handle: c.jlong, fg_rgb: c.jintArray, bg_rgb: c.jintArray, cursor_rgb: c.jintArray, palette_rgb: c.jbyteArray) callconv(.c) void {
    _ = thiz;
...
export fn Java_com_openjuicessh_app_core_terminal_GhosttyBridge_nativeFormatSelectionRange(
    env: *c.JNIEnv,
    thiz: c.jobject,
    handle: c.jlong,
    start_cell: c.jint,
...
export fn Java_com_openjuicessh_app_core_terminal_GhosttyBridge_nativeSelectWordAt(
    env: *c.JNIEnv,
    thiz: c.jobject,
    handle: c.jlong,
    cell_x: c.jint,
...
export fn Java_com_openjuicessh_app_core_terminal_GhosttyBridge_nativeSelectLineAt(
    env: *c.JNIEnv,
    thiz: c.jobject,
    handle: c.jlong,
    cell_x: c.jint,
...
export fn Java_com_openjuicessh_app_core_terminal_GhosttyBridge_nativeSelectAll(
    env: *c.JNIEnv,
    thiz: c.jobject,
    handle: c.jlong,
) callconv(.c) c.jstring {
