...
import com.openjuicessh.app.core.domain.model.AlertStatus
...
class AlertWorker @AssistedInject constructor(
    ...
    private val proxyRepository: com.openjuicessh.app.core.domain.repository.ProxyRepository,
    private val sshKeyRepository: com.openjuicessh.app.core.domain.repository.SshKeyRepository,
