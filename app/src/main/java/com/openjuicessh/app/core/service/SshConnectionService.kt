package com.openjuicessh.app.core.service
...
import com.openjuicessh.app.DaRemoteApp
import com.openjuicessh.app.MainActivity
import com.openjuicessh.app.R
...
class SshConnectionService : Service() {
    ...
    override fun onCreate() {
        ...
        scope.launch {
            combine(
                ...
                val connectedCount = statusMap.count { it.value == com.openjuicessh.app.core.domain.model.ConnectionStatus.CONNECTED }
                val activeTunnels = tunnelStates.count { it.value == com.openjuicessh.app.core.domain.model.TunnelState.ACTIVE }
    ...
    companion object {
        ...
        const val ACTION_DISCONNECT_ALL = "com.openjuicessh.app.ACTION_DISCONNECT_ALL"
    }
}
