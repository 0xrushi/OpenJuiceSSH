package com.openjuicessh.app.feature.connections
...
import com.openjuicessh.app.feature.connections.components.GroupChip
import com.openjuicessh.app.feature.connections.components.ServerCard
        ...
        Column(modifier = Modifier.padding(padding)) {
            if (state.groups.isNotEmpty()) {
                LazyRow(
                    ...
                    item {
                        GroupChip(
                            group = com.openjuicessh.app.core.domain.model.ServerGroup(
                                name = "All", color = 0
                            ),
